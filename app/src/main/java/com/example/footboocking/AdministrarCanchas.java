...
public class AdministrarCanchas extends AppCompatActivity {
    ...
    String id,id_canchas, id_usuario;
    ImageView imagen;
    ...
    public void agregarCancha(View view) {
        Intent IrLoca = new Intent(this, agregarInfoCanchas.class);
        IrLoca.putExtra("Id_canchas",id_canchas);
        IrLoca.putExtra("ID", id_usuario);
